...
public class RectPavingCompany {
    ...
    public static void main(String[] args) {
        ...
        framingCost = Float.parseFloat(scan.nextLine()); // ERROR - changed variable from cementCost to framingCost

        int area = length * width;
        int perimeter = 2*length + 2*width; // ERROR - perimeter is 2L + 2W, not 2L - 2W
        ...
        System.out.format("The cost of the framing/footers is %f.%n", perimeter*framingCost); // ERROR - total cost will equal perimeter * cost
    }
}
